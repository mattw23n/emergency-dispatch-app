"""Test configuration and fixtures for billings service."""
        ...
        with app.db.engine.begin() as connection:
            ...
            connection.execute(
                text(
                    """
                INSERT INTO `billing`
                    (`billing_id`, `incident_id`, `patient_id`,
                     `amount`, `status`, `insurance_verified`,
                     `payment_reference`, `created_at`, `updated_at`)
                VALUES
                    (1, 'INC12345', 'PAT001', 250.00, 'PENDING',
                     0, NULL, '2025-10-05 10:00:00',
                     '2025-10-05 10:00:00'),
                    (2, 'INC54321', 'PAT002', 500.00, 'VERIFIED',
                     1, NULL, '2025-10-05 10:05:00',
                     '2025-10-05 10:05:00');
            """
                )
            )
